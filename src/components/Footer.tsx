  ...
  return (
    <div className='py-24 px-4 md:px-8 lg:px-16 xl:px-32 2xl:px-64 bg-gray-100 text-sm mt-24'>
      ...
      <div className='flex flex-col md:flex-row justify-between gap-24'>
        ...
        <p>Be the first to get the latest about trends, promotions and much more!</p>
        <div className='flex'>
          ...
          <Image src="/discover.png" alt='' width={40} height={16}/>
          <Image src="/skrill.png" alt='' width={40} height={16}/>
          <Image src="/paypal.png" alt='' width={40} height={16}/>
          <Image src="/mastercard.png" alt='' width={40} height={16}/>
          <Image src="/visa.png" alt='' width={40} height={16}/>
          </div>
        </div>
      </div>
      {/* bottom */}
